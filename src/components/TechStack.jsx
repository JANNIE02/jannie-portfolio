...
const techItems = [
  { icon: FaHtml5, name: "HTML", color: "from-orange-400 to-red-500" },
  { icon: FaCss3Alt, name: "CSS", color: "from-blue-400 to-blue-600" },
  ...
  { icon: SiPostgresql, name: "PostgreSQL", color: "from-blue-500 to-indigo-600" },
  { icon: SiMongodb, name: "MongoDB", color: "from-green-500 to-emerald-600" },
  { icon: SiVercel, name: "Vercel", color: "from-gray-700 to-black" },
  { icon: SiRender, name: "Render", color: "from-teal-400 to-cyan-500" },
  { icon: FaAws, name: "AWS", color: "from-orange-500 to-yellow-500" },
];
              ...
              >
                <div className="relative p-8 rounded-2xl bg-white shadow-md hover:shadow-2xl transition-all duration-500 border border-gray-100 overflow-hidden group-hover:border-rose-200">
                  ...
                  <div className="relative z-10 text-center">
                    <div className="text-5xl mb-4 transform group-hover:scale-110 transition-transform duration-500 text-gray-700 group-hover:text-rose-500">
                      <IconComponent />
                    </div>
